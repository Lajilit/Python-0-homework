...
my_list_1 = [2, 2, 5, 12, 8, 2, 12, 3, 3, 6, 15, 888, 22]
my_list_2 = [2, 7, 12, 3]
...
days = {'01': 'первое', '02': 'второе', '03': 'третье', '04': 'четвертое',
        '06': 'шестое', '05': 'пятое', '07': 'седьмое', '08': 'восьмое',
        '09': 'девятое', '10': 'десятое', '11': 'одиннадцатое',
        '12': 'двеннадцатое', '13': 'тринадцатое', '14': 'четырнадцатое',
        ...
        '25': 'двадцать пятое', '26': 'дважцать шестое',
...
#     Примечание. Списки создайте вручную, например так:
list_1 = [2, 2, 5, 12, 8, 2, 12, 5, 3, 3, 6, 15, 888, 22]
set_1 = set(list_1)  # получили множество всех элементов
list_2 = list(set_1)
for i in list_2:
    if i in list_1:
        list_1.remove(i)
set_2 = set(list_1)  # получили множество неуникальных элементов

print(sorted(list(set_1 - set_2)))  # получили множество уникальных элементов
